...
export function activate(context: vscode.ExtensionContext) {
    ...
    function loadConfiguration() {
        let conf = vscode.workspace.getConfiguration("scrollkey");
    ...
    context.subscriptions.push(vscode.commands.registerCommand("scrollkey.up1", () => {
        scroll(-1 * line1, null);
    }));
    context.subscriptions.push(vscode.commands.registerCommand("scrollkey.up2", () => {
        scroll(-1 * line2, null);
    }));
    context.subscriptions.push(vscode.commands.registerCommand("scrollkey.up3", () => {
        scroll(-1 * line3, null);
    }));
    context.subscriptions.push(vscode.commands.registerCommand("scrollkey.down1", () => {
        scroll(line1, null);
    }));
    context.subscriptions.push(vscode.commands.registerCommand("scrollkey.down2", () => {
        scroll(line2, null);
    }));
    context.subscriptions.push(vscode.commands.registerCommand("scrollkey.down3", () => {
        scroll(line3, null);
    }));
}
